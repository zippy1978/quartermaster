...
```toml
[dependencies]
quartermaster = { git = "https://github.com/7seas-quest/quartermaster.git", branch = "main" }
```

Or with `mongodb` feature:

```toml
[dependencies]
quartermaster = { git = "https://github.com/7seas-quest/quartermaster.git", branch = "main", features = ["mongodb"] }
```
